...
def write_excel1():
  ...
  sheet1 = f.add_sheet(u'country code',cell_overwrite_ok=True) #创建sheet2
  row0 = [u'国家',u'国家代码',u'2.4G发射功率',u'5G发射功率1',u'5G发射功率2']
  row1 = ["China",'156','20','20','22']

  #生成第一行
  for i in range(len(row0)):
    sheet1.write(0,i,row0[i],set_style('Times New Roman',180,True))
